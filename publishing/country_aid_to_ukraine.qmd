...
war_support_tracker %>% 
  ...
  mutate(
    across(
      c(moscow_distance_km, `Total aid (bilateral + EU) in % of GDP`),
      .fns=log10)
  ) %>% 
  ...
  scale_size(range = c(0.5, 15),
             breaks = c(0.1e12, 1e12, 2e12, 3e12),
             labels = c("0.1", "1", "2", "3"),
             name = "GDP (Trillion EUR)") +
  labs(title = "Log/Log of EU Country Distance to Moscow vs GDP % Aid to Ukraine",
       x = "Log10 Distance from Country to Moscow",
       y = "Log10 Total Aid as % of GDP") +
